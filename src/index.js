...
// API_KEY = "42622707-d3cf547bb9e78dbb6ae1d32a2";
...
const searchParams = new URLSearchParams({
    key: '42622707-d3cf547bb9e78dbb6ae1d32a2',
    q: '',
    image_type: 'photo',
...
const fetchPhotos = async () => {
  ...
  const searchResults = await axios.get(`https://pixabay.com/api/?${searchParams}`);
